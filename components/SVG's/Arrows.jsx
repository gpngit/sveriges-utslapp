...
export const ArrowStyleTwo = ({ color, width, strokeWidth }) => {
    return (
        ...
        role="img"
        alt="Pil"
        width={width} viewBox="0 0 263 58" fill="none" xmlns="http://www.w3.org/2000/svg">
        <title>Pil</title>
            <desc>En pil som pekar på något viktigt</desc>
...
export const ArrowStyleThree = ({ color, width, strokeWidth }) => {
    return (
        ...
        <SVG role="img"
        alt="Pil"
        width={width} viewBox="0 0 256 53" fill="none" xmlns="http://www.w3.org/2000/svg">
        <title>Pil</title>
            <desc>En pil som pekar på något viktigt</desc>
...
export const ArrowStyleFour = ({ color, width, strokeWidth }) => {
    return (
        <>
        <SVG width={width} viewBox="0 0 202 55" fill="none"
        role="img"
        alt="Pil"
        xmlns="http://www.w3.org/2000/svg">
        <title>Pil</title>
