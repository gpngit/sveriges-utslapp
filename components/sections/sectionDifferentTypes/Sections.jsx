...
clip-path: polygon(0% 70%, 4% 50%, 8% 50%, 12% 26%, 16% 26%, 20% 14%, 24% 18%, 28% 11%, 32% 0%, 36% 11%, 40% 38%, 44% 6%, 46% 10%, 48% 5%, 52% 16%, 56% 10%, 60% 15%, 64% 34%, 68% 0%, 70% 25%, 74% 30%, 80% 32%, 84% 44%, 88% 10%, 92% 26%, 96% 18%, 100% 55%, 100% 100%, 0% 100%);
